...
2. **Si no aparece o da error de permisos**: DETENTE. Dile al agente que necesita aceptar la invitación de colaborador que le mandó Gerardo a su correo, o pedírsela por WhatsApp al +52 442 157 1141. PROHIBIDO ABSOLUTO crear otra base, tabla o campo como sustituto.
...
Cierra el onboarding explicando en corto: la meta diaria se alcanza con rampa anti-baneo de Meta — **8 WhatsApps/día las primeras 2 semanas → 14 las siguientes 2 → hasta su meta (típico 20)** solo con número rodado; recomiéndale WhatsApp Business con perfil completo. Los mensajes SIEMPRE los manda él a mano desde su teléfono; el kit se los deja listos en su panel. Termina diciéndole que corra su primera prospección con: "corre mi prospección de hoy".
...
5. Registros ya escritos no se reescriben; los avances van por cambio de Estatus y notas AÑADIDAS (nunca borrar notas previas).
